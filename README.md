...
Klüme(클룸)은 부트캠프 현장에서 반복적으로 발생했던 **회의실 선착순 구두 예약의 불편함과 비효율성**을 해결하기 위해 만든 조직 기반 회의실 예약 서비스입니다.
<br>

줄서기, 가위바위보, 중복 예약, 공지 전달 누락 등 오프라인 방식에서 생기던 문제들을 디지털 방식으로 개선하고, <br>
누구나 동등한 조건에서 공정하게 예약할 수 있도록 설계했습니다.<br>

- ⏱ 예약 오픈 카운트다운 + 선착순 경쟁 처리 (티켓팅 방식)
- 📅 일/주/월 단위 예약 현황 조회
- 🏢 조직 단위 관리(관리자/멤버 권한)
- 💬 실시간 채팅 문의
- ⚠️ 패널티 기반 질서 유지(노쇼 방지)
